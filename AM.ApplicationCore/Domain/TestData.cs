namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
       ...
       ,
        ...
        public static Flight flight2 = new Flight { FlightDate = new DateTime(2022, 02, 01, 21, 10, 10), Destination = "Paris",Departure="Tunis", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, Plane = BoingPlane };
